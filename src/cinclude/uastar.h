...
extern int32_t path_finder_get_score(struct path_finder *path_finder, int32_t col, int32_t row);
extern int32_t path_finder_get_heuristic_score(struct path_finder *path_finder, int32_t col, int32_t row);
extern uint8_t path_finder_is_possible_target(struct path_finder *path_finder, int32_t col, int32_t row);
extern uint8_t path_finder_is_passable(struct path_finder *path_finder, int32_t col, int32_t row);
extern uint8_t path_finder_is_path(struct path_finder *path_finder, int32_t col, int32_t row);
extern uint8_t path_finder_is_closed(struct path_finder *path_finder, int32_t col, int32_t row);
extern uint8_t path_finder_is_open(struct path_finder *path_finder, int32_t col, int32_t row);
extern uint8_t path_finder_is_start(struct path_finder *path_finder, int32_t col, int32_t row);
extern uint8_t path_finder_is_end(struct path_finder *path_finder, int32_t col, int32_t row);
extern void path_finder_begin(struct path_finder *path_finder);
extern uint8_t path_finder_find_step(struct path_finder *path_finder, void *data);
extern void path_finder_find(struct path_finder *path_finder, void *data);
extern void path_finder_set_start(struct path_finder *path_finder, int32_t col, int32_t row);
extern void path_finder_set_end(struct path_finder *path_finder, int32_t col, int32_t row);
extern void path_finder_clear_score(struct path_finder *path_finder);
extern void path_finder_clear_path(struct path_finder *path_finder);
extern void path_finder_fill(struct path_finder *path_finder);
extern void path_finder_initialize(struct path_finder *path_finder);
